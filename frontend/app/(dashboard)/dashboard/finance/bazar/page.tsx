    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Bazar Entries</h1>
                    <p className="text-gray-600 mt-1">Submit and manage bazar expenses</p>
                </div>
                <button
                    onClick={() => {
                        if (!isManager) {
            ...
            {showAddForm && (
                <div className="bg-white rounded-xl shadow-sm p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Bazar Entry</h3>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div className="space-y-3">
                        {pendingBazars.map((bazar) => (
                            <div key={bazar.id} className="flex items-center justify-between p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                <div>
                                    <p className="font-semibold text-gray-900">{formatCurrency(bazar.amount)}</p>
                                    <p className="text-sm text-gray-600">{bazar.items}</p>
                                    <p className="text-xs text-gray-500 mt-1">{new Date(bazar.date).toLocaleDateString()}</p>
                                </div>
                                <button
            ...
            <div className="bg-white rounded-xl shadow-sm">
                ...
                <div className="p-6">
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">No bazar entries yet</p>
                        <p className="text-sm text-gray-400 mt-1">Submit your first bazar expense</p>
                    </div>
                </div>
            </div>
        </div>
