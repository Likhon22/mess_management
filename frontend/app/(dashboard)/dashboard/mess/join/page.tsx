    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Join Existing Mess</h1>
                <p className="text-gray-600 mb-6">Enter the mess ID to send a join request</p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none uppercase text-gray-900"
